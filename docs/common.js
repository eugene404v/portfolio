...
/* harmony import */ var _modules_typeWriter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/typeWriter */ "./src/js/modules/typeWriter.js");
/* harmony import */ var _modules_socCube__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/socCube */ "./src/js/modules/socCube.js");
/* harmony import */ var _modules_socCube__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_socCube__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _modules_menuColors__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/menuColors */ "./src/js/modules/menuColors.js");
/* harmony import */ var _modules_headers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/headers */ "./src/js/modules/headers.js");
/* harmony import */ var _modules_headers__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_headers__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./data */ "./src/js/data.js");
...
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_7__["default"]('.swiper-container', {
  slidesPerView: 5,
  spaceBetween: 1,
  centeredSlides: true
});
...
swiper.on('slideChange', function () {
  ...
  slidesAll.forEach(function (el) {
    return el.classList.remove('sw-act');
  });
  ...
  titles[swiper.activeIndex + 3] && titles[swiper.activeIndex + 3].classList.add('sub-sub-sub-active'); //content rm opened
  //textcontent = ''
});
document.querySelectorAll('.swiper-slide').forEach(function (el) {
  ...
  el.addEventListener('click', function (e) {
    if (el.classList.contains('swiper-slide-active') || el.closest('swiper-slide-active')) {
      ...
      header.textContent = _data__WEBPACK_IMPORTED_MODULE_8__["default"][swiper.activeIndex].title; //text.textContent = data[swiper.activeIndex].a
    }
  });
}); // btn 
//counter in circle
...
var s2 = document.querySelector('#works');
var s3 = document.querySelector('#about');
...
var frontSide = document.querySelector('.front');
var bottomSide = document.querySelector('.bottom');
...
frontSide.addEventListener('mouseover', function () {
  cube.classList.add('fronted');
});
frontSide.addEventListener('mouseout', function () {
  cube.classList.remove('fronted');
});
bottomSide.addEventListener('mouseover', function () {
  cube.classList.add('bottomed');
});
bottomSide.addEventListener('mouseout', function () {
...
var input = document.querySelector('.first__techs--writing');
var text = ['ReactJS ', 'Redux ', 'AntDesign ', 'TypeScript '];
var line = 0;
var count = 0;
var wordReverse = 0;
var out = '';
