...
/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./data */ "./src/js/data.js");
...
swiper.on('slideChange', function () {
  ...
  titles[swiper.activeIndex + 3] && titles[swiper.activeIndex + 3].classList.add('sub-sub-sub-active'); //slides rm sw-act
  //content rm opened
  //textcontent = ''
});
document.querySelectorAll('.swiper-slide').forEach(function (el) {
  el.addEventListener('click', function (e) {
    if (el.classList.contains('swiper-slide-active') || el.closest('swiper-slide-active')) {
      el.classList.toggle('sw-act'); // content add opened
      //header.textContent = data[swiper.activeIndex].b
...
var text = ['Aurelia ', 'ModX ', 'Laravel ', 'Docker '];
var line = 0;
var count = 0;
var wordReverse = 0;
var out = '';
